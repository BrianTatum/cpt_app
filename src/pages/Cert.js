				...
				<div className='container'>
					...
					<section id="cert-sec" className="cpt-cert">
						<section className="cert-fraim">
							...
							<h3 id="cert-date" className="text-center" style={certMargins0}>{months[certDate.getMonth()]}, {certDate.getDay()} {certDate.getFullYear()}</h3>
							<p className="text-justify" style={firstSignLine}>This is to certify that I have completed the Child Protection Training online className by watching all four of the video sections of the course and personally answering all questions of the exam. I also understand that a criminal and sex offender background check will be attached with this certificate.</p>
