		          ...
		          <div className='col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4 col-md-3 col-md-offset-1'>
		            ...
		            <div className='block-center text-center'>
		              ...
		              <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
		                ...
		                <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif"  name="submit" alt="PayPal - The safer, easier way to pay online!" className='block-center' />
		                <img alt="" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1" className='block-center' />
		              </form>
		            </div>
		          </div>
		          <div className='col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4 col-md-3 col-md-offset-1'>
